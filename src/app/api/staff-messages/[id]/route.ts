...
async function getOwnedStaffMessage(id: string, userId: string) {
  return prisma.staffMessage.findFirst({
...
export async function PATCH(
  ...
  const message = await getOwnedStaffMessage(id, session.user.id);
  if (!message) {
